...
<header class="main-header fixed top-0 left-0 right-0 z-50 bg-white border-b border-gray-100 shadow-sm">
    ...
    <div class="header-content w-full px-2 sm:px-8 py-1 sm:py-2 flex flex-wrap items-center justify-between sm:gap-x-4">
        ...
        <div id="mobileSearchContainer" class="order-3 sm:order-2 flex-none w-full sm:flex-1 sm:w-auto relative group flex gap-3 items-center min-w-0">
            <div class="search-bar flex-1 flex items-center bg-slate-100/50 border border-slate-200 rounded-2xl overflow-hidden focus-within:bg-white focus-within:ring-4 focus-within:ring-gray-100 focus-within:border-gray-200 transition-all duration-300 w-full pr-2">
                ...
                <button class="bg-slate-900 text-white px-5 py-2 m-1 rounded-xl text-sm font-bold hover:bg-slate-800 transition-all uppercase tracking-wider hidden sm:block">RECHERCHE</button>
            </div>
            <!-- Publish Button (Desktop Only) -->
            <a href="publish.html" class="shrink-0 bg-gray-900 text-white px-5 py-2 m-1 rounded-xl text-sm font-bold hover:bg-gray-800 transition-colors hidden sm:flex items-center gap-2 publish-btn h-[40px]">
        ...
        <div class="order-2 sm:order-3 flex items-center gap-1.5 sm:gap-2 shrink-0">
            ...
            <a href="notifications.html" class="relative p-1 sm:p-2 rounded-lg hover:bg-gray-50 transition-colors hidden sm:block" title="Notifications">
